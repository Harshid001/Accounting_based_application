...
import { DeadlineBuckets } from '@/desktop/dashboard/components/DeadlineBuckets';
import { StatRow } from '@/desktop/dashboard/components/StatRow';
import { TaskBreakdown } from '@/desktop/dashboard/components/RecentActivity';
import { WorkloadPanel } from '@/desktop/dashboard/components/WorkloadPanel';
