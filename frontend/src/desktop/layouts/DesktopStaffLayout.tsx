...
export function DesktopStaffLayout() {
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <div className="relative flex min-h-0 flex-1 overflow-hidden">
          <main
            ...
            tabIndex={-1}
            className={cn(
              'min-h-0 min-w-0 flex-1 transition-all duration-400 ease-in-out outline-none',
              isAgentRoute
          ...
          >
            <div
              className={cn(
                'mx-auto w-full',
                isAgentRoute ? 'flex h-full flex-1 flex-col' : 'max-w-[1440px]',
              )}
            >
              <Suspense
                fallback={
              ...
              >
                <div
                  ...
                  className={cn('page-transition', isAgentRoute && 'flex h-full flex-1 flex-col')}
                >
                  <Outlet />
                </div>
              </Suspense>
